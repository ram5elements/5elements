...
@section('content')
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <h4><i class="icon-reorder"></i>Add Party Details</h4>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ asset ("admin/add_new_party") }}" class="horizontal-form" method="post">
                <input type="hidden" value="{{ csrf_token() }}" name="_token">
                <input type="hidden" name="created_by" value="{{$user_id}}"/>
                <div class="row-fluid">
                    <div class="span4">
                        <div class="control-group">
                                <a href="{{ asset ("admin/view_party") }}"  class="btn green">View <i class="icon-plus"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row-fluid">
