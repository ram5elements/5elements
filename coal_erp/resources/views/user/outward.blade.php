        ...
        <div class="span12">
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="{{asset('user/Outward_submit')}}" id="form_sample_2" method="post">
                        ...
                        <div class="row-fluid">
                            <div class="span3 ">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span12 chosen" name="po_entry_id" onchange="Get_DO_Data(this.value)">
                                            <option value="">Select...</option>
                                            @foreach($PO_Entry as $value)
                                                <option value="{{ $value->po_entry_id }}">{{ $value->po_number }}-{{ $value->po_date }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row-fluid">
                            <div class="span3 ">
							 ...
							 <div class="span3">
                                  ...
                                  <div class="controls">
                                      <input type="text" name="date" class="m-wrap m-ctrl-medium date-picker" size="16" required />
                                  </div>
                                  </div>
                              </div>
							    <div class="span3 ">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="m-wrap m-ctrl-medium " name="loading_type" size="16" type="text"  required />
							...
							<div class="row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="m-wrap m-ctrl-medium " name="t_weigth" size="16" type="text"  required />
                            ...
                            <div class="span3 ">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="m-wrap m-ctrl-medium " name="advanced" size="16" type="text" required  />
            ...
            $.ajax({
                ...
                success: function(re){
                    ...
                    var do_data = obj.DO_Data.length;
                            ...
                            return_data +=" <td>"+obj.DO_Data.po_number +"</td>";
